<script setup>
    ...
    const openCertificatePreview = (certificateId) => {
        activeCertificateId.value = certificateId;
                            ...
                            <div class="relative p-5">
                                ...
                                <div class="flex items-center justify-between mt-4">
                                    ...
                                    <button
                                        ...
                                        class="inline-flex items-center gap-2 px-4 py-2 rounded-lg text-white text-sm font-medium transition-all duration-200 shadow-md bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 hover:shadow-lg"
                                    >
