...
const form = useForm({
    ...
    author_name: props.testimony.author_name || '',
    author_role: props.testimony.author_role || '',
    item_id: props.testimony.item_id,
    item_label: props.testimony.item_label || props.testimony.product?.name || '',
...
<template>
    <FormSection @submitted="editarTestimony" class="">
        ...
        <template #description>
            Editar Testimonio. Todos los campos son opcionales (incluido el video).
        </template>
