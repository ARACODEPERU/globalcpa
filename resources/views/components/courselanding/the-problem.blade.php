                        ...
                        @if (filled($landing->problem_section['items'][0] ?? null))
                            <div class="col-md-4" data-aos="zoom-in" data-aos-delay="100">
                                <div
                                    ...
                                    <div class="mb-4">
                                        <i class="fa {{ $landing->problem_section['items'][0]['icon']  }} text-[#f8aa4b]" style="font-size: 3.5rem;"></i>
                                    </div>
                        ...
                        @if (filled($landing->problem_section['items'][1] ?? null))
                            <div class="col-md-4" data-aos="zoom-in" data-aos-delay="200">
                                <div
                                    class="h-100 p-4 rounded-4 border shadow-sm text-center bg-white transition-all">
                                    <div class="mb-4">
                                        <i class="fa {{ $landing->problem_section['items'][1]['icon']  }} text-[#f8aa4b]" style="font-size: 3.5rem;"></i>
                                    </div>
                        ...
                        @if (filled($landing->problem_section['items'][2] ?? null))
                            <div class="col-md-4" data-aos="zoom-in" data-aos-delay="300">
                                <div
                                    class="h-100 p-4 rounded-4 border shadow-sm text-center bg-white transition-all">
                                    <div class="mb-4">
                                        <i class="fa {{ $landing->problem_section['items'][2]['icon']  }} text-[#f8aa4b]" style="font-size: 3.5rem;"></i>
                                    </div>
