                                    ...
                                    style="border-top: 5px solid #f8aa4b !important;">
                                        ...
                                        <div class="card-body p-4 text-center">
                                            ...
                                            <button type="button" data-bs-toggle="modal" data-bs-target="#modalFinanciamiento"
                                                ...
                                                <span>Resolver mis consultas</span>
                                            </button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="modal-content border-0 shadow-lg rounded-4 bg-item-custom">
                            ...
                            <div class="modal-body p-4 p-lg-5 pt-0">
                                <div class="text-center mb-4">
                                    ...
                                    <p class="text-muted dark:text-gray-400">Completa tus datos para recibir la información y asegurar tu participación.</p>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group shadow-sm">
                                                ...
                                                <input type="text" name="phone" class="form-control border-start-0 ps-0 dark:bg-gray-700 dark:text-white dark:border-gray-600 bg-white" placeholder="955 555 555" inputmode="numeric" pattern="[0-9]*" minlength="8" oninput="this.value = this.value.replace(/[^0-9]/g, '')" required>
                                            </div>
                                        </div>
                                    </div>
