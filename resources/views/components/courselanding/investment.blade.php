            ...
            <div class="col-md-12">
                <div class="card-body p-4 p-lg-5">
                    <div class="text-center mb-5">
                        ...
                        <p class="text-gray-600 dark:text-gray-400 fs-5 mx-auto"
                                ...
                                <div class="col-md-4" data-aos="zoom-in" data-aos-delay="200"> {{-- Removed inline style for border-top --}}
                                    ...
                                    style="border-top: 5px solid #f8aa4b !important;">
                                        ...
                                        style="background-color: rgba(255, 193, 7, 0.05);">
                                            ...
                                            <small class="text-gray-500 dark:text-gray-400 text-[15px]">La más recomendada</small>
                                        </div>
                                        <div class="card-body p-4 text-center">
                                            ...
                                            <button type="button" data-bs-toggle="modal" data-bs-target="#modalFinanciamiento"
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="20" height="20" style="flex-shrink: 0;">
                        ...
                        <div class="modal-content border-0 shadow-lg rounded-4 bg-item-custom">
                            ...
                            <div class="modal-body p-4 p-lg-5 pt-0">
                                <div class="text-center mb-4">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free v7.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2026 Fonticons, Inc.--><path d="M380.9 97.1c-41.9-42-97.7-65.1-157-65.1-122.4 0-222 99.6-222 222 0 39.1 10.2 77.3 29.6 111L0 480 117.7 449.1c32.4 17.7 68.9 27 106.1 27l.1 0c122.3 0 224.1-99.6 224.1-222 0-59.3-25.2-115-67.1-157zm-157 341.6c-33.2 0-65.7-8.9-94-25.7l-6.7-4-69.8 18.3 18.6-68.1-4.4-7c-18.5-29.4-28.2-63.3-28.2-98.2 0-101.7 82.8-184.5 184.6-184.5 49.3 0 95.6 19.2 130.4 54.1s56.2 81.2 56.1 130.5c0 101.8-84.9 184.6-186.6 184.6zM325.1 300.5c-5.5-2.8-32.8-16.2-37.9-18-5.1-1.9-8.8-2.8-12.5 2.8s-14.3 18-17.6 21.8c-3.2 3.7-6.5 4.2-12 1.4-32.6-16.3-54-29.1-75.5-66-5.7-9.8 5.7-9.1 16.3-30.3 1.8-3.7 .9-6.9-.5-9.7s-12.5-30.1-17.1-41.2c-4.5-10.8-9.1-9.3-12.5-9.5-3.2-.2-6.9-.2-10.6-.2s-9.7 1.4-14.8 6.9c-5.1 5.6-19.4 19-19.4 46.3s19.9 53.7 22.6 57.4c2.8 3.7 39.1 59.7 94.8 83.8 35.2 15.2 49 16.5 66.6 13.9 10.7-1.6 32.8-13.4 37.4-26.4s4.6-24.1 3.2-26.4c-1.3-2.5-5-3.9-10.5-6.6z"/></svg>
                                    <h2 class="fw-bold text-navy-custom text-[24px]">Asegurar vacante y/o financiamiento</h2>
                                    <p class="text-muted dark:text-gray-400">Déjanos tus datos para que un asesor te ayude con el proceso de inscripción y opciones de pago.</p>
                                </div>
                                <form id="modalContactForm">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group shadow-sm">
                                            <span class="input-group-text bg-gray-50 dark:bg-gray-700 border-end-0 text-muted dark:text-gray-400"><i class="fa-solid fa-user"></i></span>
                                            <input type="text" name="full_name" class="form-control border-start-0 ps-0 dark:bg-gray-700 dark:text-white dark:border-gray-600 bg-white" placeholder="Nombre completo" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group shadow-sm">
                                            <span class="input-group-text bg-white dark:bg-gray-700 border-end-0"><i class="fa fa-flag text-muted"></i></span>
                                            <select name="country_phone" id="modalCountryPhoneSelect" class="form-select border-start-0 ps-0 dark:bg-gray-700 dark:text-white dark:border-gray-600 bg-white" required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group shadow-sm">
                                                <span class="input-group-text bg-gray-50 dark:bg-gray-700 border-end-0 text-gray-600 dark:text-gray-400">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" style="width: 16px; height: 16px;" fill="currentColor" class="opacity-75">
                                                        <path d="M380.9 97.1c-41.9-42-97.7-65.1-157-65.1-122.4 0-222 99.6-222 222 0 39.1 10.2 77.3 29.6 111L0 480 117.7 449.1c32.4 17.7 68.9 27 106.1 27l.1 0c122.3 0 224.1-99.6 224.1-222 0-59.3-25.2-115-67.1-157zm-157 341.6c-33.2 0-65.7-8.9-94-25.7l-6.7-4-69.8 18.3 18.6-68.1-4.4-7c-18.5-29.4-28.2-63.3-28.2-98.2 0-101.7 82.8-184.5 184.6-184.5 49.3 0 95.6 19.2 130.4 54.1s56.2 81.2 56.1 130.5c0 101.8-84.9 184.6-186.6 184.6zM325.1 300.5c-5.5-2.8-32.8-16.2-37.9-18-5.1-1.9-8.8-2.8-12.5 2.8s-14.3 18-17.6 21.8c-3.2 3.7-6.5 4.2-12 1.4-32.6-16.3-54-29.1-75.5-66-5.7-9.8 5.7-9.1 16.3-30.3 1.8-3.7 .9-6.9-.5-9.7s-12.5-30.1-17.1-41.2c-4.5-10.8-9.1-9.3-12.5-9.5-3.2-.2-6.9-.2-10.6-.2s-9.7 1.4-14.8 6.9c-5.1 5.6-19.4 19-19.4 46.3s19.9 53.7 22.6 57.4c2.8 3.7 39.1 59.7 94.8 83.8 35.2 15.2 49 16.5 66.6 13.9 10.7-1.6 32.8-13.4 37.4-26.4s4.6-24.1 3.2-26.4c-1.3-2.5-5-3.9-10.5-6.6z"/>
                                                    </svg>
                                                </span>
                                                <input type="text" name="phone" class="form-control border-start-0 ps-0 dark:bg-gray-700 dark:text-white dark:border-gray-600 bg-white" placeholder="999 888 777" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label fw-bold text-navy-custom">Correo Electrónico</label>
                                            <div class="input-group shadow-sm">
                                                <span class="input-group-text bg-gray-50 dark:bg-gray-700 border-end-0 text-muted dark:text-gray-400"><i class="fa-solid fa-envelope"></i></span>
                                                <input type="email" name="email" class="form-control border-start-0 ps-0 dark:bg-gray-700 dark:text-white dark:border-gray-600 bg-white" placeholder="ejemplo@correo.com" required>
                                            </div>
                                        </div>
                                    </div>
                                    <button type="submit" id="submitModalContactButton" class="btn btn-warning btn-lg w-100 fw-bold shadow-sm py-3 mt-2 text-[#002060] rounded-xl">
