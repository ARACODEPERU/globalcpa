        ...
        <div
            ...
            <div class="flex pt-4">
                <a href="/">
                    <img x-show="!$store.global.isDarkModeEnabled"
                        ...
                        src="{{ asset('storage/' . $logo[3]->content) }}" alt="Logo" />
                    <img x-show="$store.global.isDarkModeEnabled"
                        class="size-11 transition-transform duration-500 ease-in-out hover:rotate-[360deg]"
                        src="{{ asset('storage/' . $logo[4]->content) }}" alt="Logo" />
                </a>
            </div>
            ...
            <div class="is-scrollbar-hidden flex grow flex-col space-y-4 overflow-y-auto pt-6">
                <a href="{{ route('index_main') }}" style="text-decoration: none;"
                    ...
                    <i class="fas fa-home" aria-hidden="true" style="font-size: 26px;"></i>
                </a>
                <a href="{{ route('web_courses') }}"
                    ...
                    <i class="fas fa-graduation-cap" aria-hidden="true" style="font-size: 26px;"></i>
                </a>
                <a href="{{ route('web_subscriptions') }}"
                    ...
                    <i class="fas fa-briefcase" aria-hidden="true" style="font-size: 26px;"></i>
                </a>
                <a href="{{ route('web_book_amauta') }}"
                    ...
                    <i class="fas fa-book" aria-hidden="true" style="font-size: 26px;"></i>
                </a>
            </div>
