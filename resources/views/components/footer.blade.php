<div>
    ...
    <footer style="background: #020024;
        ...
        <div class="container-fluid">
            <div class="row" style=" padding: 80px 0px;">
                ...
                <div class="col-md-2" style="padding: 15px; text-align:center;">
                    <img style="width: 90%;" src="{{ asset('themes/webpage/images/Logo_cpa_negativo.png') }}"
                        alt="">
                </div>
                <div class="col-md-3" style="padding: 15px;">
                    ...
                    <ul>
                        <li class="font-medium line-clamp-1 dark:text-navy-100">
                            <a href="{{ route('politicas_privacidad') }}" style="color: #fff;">Políticas de privacidad</a>
                        </li>
                        <li class="font-medium line-clamp-1 dark:text-navy-100">
                            <a href="{{ route('politicas_devoluciones') }}" style="color: #fff;">Políticas de devoluciones</a>
                        </li>
                        <li class="font-medium line-clamp-1 dark:text-navy-100">
                ...
                <div class="col-md-3" style="padding: 15px;">
                    <h2 style="color: #fff; font-size: 20px; padding-bottom: 10px;"><b>CONTÁCTANOS</b></h2>
                    <ul>
