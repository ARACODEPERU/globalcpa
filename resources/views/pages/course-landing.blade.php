                            ...
                            <div class="card-body p-4 p-lg-5">
                                ...
                                <form id="pageContactForm">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group shadow-sm">
                                            <select name="country" id="countrySelect" class="form-select border-start-0 ps-0" style="width: 100%" required>
                                                <optgroup label="Sudamérica">
                                                    <option value="Perú" data-code="pe" data-prefix="+51" selected>Perú</option>
                                                    <option value="Argentina" data-code="ar" data-prefix="+54">Argentina</option>
                                                    <option value="Bolivia" data-code="bo" data-prefix="+591">Bolivia</option>
                                                    <option value="Brasil" data-code="br" data-prefix="+55">Brasil</option>
                                                    <option value="Chile" data-code="cl" data-prefix="+56">Chile</option>
                                                    <option value="Colombia" data-code="co" data-prefix="+57">Colombia</option>
                                                    <option value="Ecuador" data-code="ec" data-prefix="+593">Ecuador</option>
                                                    <option value="Guyana" data-code="gy" data-prefix="+592">Guyana</option>
                                                    <option value="Paraguay" data-code="py" data-prefix="+595">Paraguay</option>
                                                    <option value="Surinam" data-code="sr" data-prefix="+597">Surinam</option>
                                                    <option value="Uruguay" data-code="uy" data-prefix="+598">Uruguay</option>
                                                    <option value="Venezuela" data-code="ve" data-prefix="+58">Venezuela</option>
                                                </optgroup>
                                                <optgroup label="Mundo">
                                                    ...
                                                    <option value="Estados Unidos" data-code="us" data-prefix="+1">Estados Unidos</option>
                                                    <option value="Panamá" data-code="pa" data-prefix="+507">Panamá</option>
                                                    <option value="Costa Rica" data-code="cr" data-prefix="+506">Costa Rica</option>
                                                    <option value="Italia" data-code="it" data-prefix="+39">Italia</option>
                                                    <option value="Portugal" data-code="pt" data-prefix="+351">Portugal</option>
                                                </optgroup>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group shadow-sm">
                                                ...
                                                <span id="phonePrefix" class="input-group-text bg-white border-start-0 border-end-0 text-muted fw-bold px-1">+51</span>
                                                <input type="text" name="phone"
                                                    class="form-control border-start-0 ps-1" placeholder="999 888 777" style="border-left: 0 !important;"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                ...
                                <div class="sticky-top" style="top: 100px; z-index: 1;">
                                    <div class="p-2">
                                        ...
                                        <div class="p-4 rounded-4 shadow-sm border-0 bg-white position-relative overflow-hidden transition-all" style="border-left: 6px solid #ffc107 !important;">
                                            ...
                                            <a href="https://wa.me/tu-numero" class="btn btn-warning w-100 fw-bold py-3 shadow-sm rounded-3 d-flex align-items-center justify-content-center" style="color: #002060;">
