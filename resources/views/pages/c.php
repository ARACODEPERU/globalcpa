                                        ...
                                        <div class="tab-pane fade show active" id="todos" role="tabpanel"
                                            ...
                                            @for ($i = 0; $i < $yy; $i++)
                                                <div class="row widget-grid page-group page-{{ $i + 1 }}"
                                                    ...
                                                    @foreach ($courses->skip($p * $i)->take($p) as $key => $item)
                                                        <div class="col-xl-4 col-md-6 col-sm-12 box-col-4" data-aos="fade-up" data-aos-delay="{{ ($key % 3) * 100 }}">
                                                ...
                                                <div class="row widget-grid">
                                                    @foreach ($courses as $item)
                                                        @if (strtolower($item->additional) == strtolower($type))
                                                            <div class="col-xl-4 col-md-6 col-sm-12 box-col-4" data-aos="fade-up">
                                                                <div class="card weekend-card">
                                                                    <div class="card-body">
                                                                        <a
                                                                            href="{{ route('web_course_description', $item->id) }}">
