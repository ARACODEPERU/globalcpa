    ...
    <div class="page-wrapper" id="pageWrapper">
        ...
        <div class="page-body-wrapper">
            ...
            <div class="page-body" x-data>
                ...
                <!-- Propuesta de Diseño Moderno Opción 5 (Avatares ejecutivos en escala de grises) -->
                <div class="container-fluid mt-5">
                    <div class="card border-0 overflow-hidden shadow mb-4"
                        style="background: linear-gradient(135deg, #002060 0%, #004080 100%); border-radius: 20px;"
                        data-aos="fade-up">
                        ...
                        <div class="card-body p-4 p-lg-5 position-relative">
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-5 d-none d-lg-block">
                                    <div class="teacher-avatar-cloud-5 position-relative" style="min-height: 280px;">
                                        <!-- Avatares flotantes de docentes (ejecutivos, escala de grises) -->
                                        <img src="https://source.unsplash.com/1560250097-0b93528c311a/150x150?grayscale" class="avatar-item item-1 shadow-lg" alt="Docente 1">
                                        <img src="https://source.unsplash.com/1556157382-97eda2d62296/150x150?grayscale" class="avatar-item item-2 shadow" alt="Docente 2">
                                        <img src="https://source.unsplash.com/1438761681033-6461ffad8d80/150x150?grayscale" class="avatar-item item-3 shadow" alt="Docente 3">
                                        <img src="https://source.unsplash.com/1544005313-94ddf0286df2/150x150?grayscale" class="avatar-item item-4 shadow" alt="Docente 4">
                                        <img src="https://source.unsplash.com/1507003211169-0a1dd7228f2d/150x150?grayscale" class="avatar-item item-5 shadow" alt="Docente 5">
                                        <img src="https://source.unsplash.com/1580489944761-15a19d654956/150x150?grayscale" class="avatar-item item-6 shadow" alt="Docente 6">
                                        <img src="https://source.unsplash.com/1535713875002-d1d0cf377fde/150x150?grayscale" class="avatar-item item-7 shadow" alt="Docente 7">
                                        <img src="https://source.unsplash.com/1599566150163-29194dcaad36/150x150?grayscale" class="avatar-item item-8 shadow" alt="Docente 8">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <style>
                    .teacher-avatar-cloud-5 .avatar-item {
                        position: absolute;
                        border-radius: 50%;
                        border: 3px solid rgba(255, 255, 255, 0.5);
                        animation: float-avatars-5 6s ease-in-out infinite;
                    }
                    .teacher-avatar-cloud-5 .item-1 { width: 110px; height: 110px; top: 50%; left: 50%; z-index: 5; animation-name: float-avatars-center-5; animation-duration: 5s; }
                    .teacher-avatar-cloud-5 .item-2 { width: 70px; height: 70px; top: 10%; left: 25%; animation-delay: -1s; }
                    .teacher-avatar-cloud-5 .item-3 { width: 80px; height: 80px; top: 20%; left: 75%; animation-delay: -2.5s; animation-duration: 7s; }
                    .teacher-avatar-cloud-5 .item-4 { width: 60px; height: 60px; top: 70%; left: 15%; animation-delay: -4s; }
                    .teacher-avatar-cloud-5 .item-5 { width: 90px; height: 90px; top: 65%; left: 65%; animation-delay: -0.5s; animation-duration: 8s; }
                    .teacher-avatar-cloud-5 .item-6 { width: 55px; height: 55px; top: 5%; left: 5%; animation-delay: -2s; animation-duration: 6.5s; }
                    .teacher-avatar-cloud-5 .item-7 { width: 75px; height: 75px; top: 80%; left: 90%; animation-delay: -3s; animation-duration: 7.5s; }
                    .teacher-avatar-cloud-5 .item-8 { width: 65px; height: 65px; top: 15%; left: 95%; animation-delay: -5s; animation-duration: 6s; }

                    @keyframes float-avatars-5 {
                        0%, 100% { transform: translateY(0px) rotate(5deg); }
                        50% { transform: translateY(-15px) rotate(-5deg); }
                    }
                    @keyframes float-avatars-center-5 {
                        0%, 100% { transform: translate(-50%, -50%) translateY(0px) rotate(5deg); }
                        50% { transform: translate(-50%, -50%) translateY(-15px) rotate(-5deg); }
                    }
                </style>
