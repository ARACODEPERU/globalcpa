                            ...
                            p-4 dark:border-navy-500 sm:flex-row sm:justify-between sm:space-y-0 sm:px-5">
                                ...
                                <div class="section">
                                    ...
                                    <ul style="margin-top: 5px; margin-bottom: 15px; padding-left: 25px;">
                                        ...
                                        <li style="margin-bottom: 5px;">La devolución del monto abonado en un plazo máximo
                                            de <strong>15 días hábiles</strong>.</li>
                                    </ul>
                                </div>
                                ...
                                <div class="section">
                                    ...
                                    <ul style="margin-top: 5px; margin-bottom: 15px; padding-left: 25px;">
                                        <li style="margin-bottom: 5px;"><strong>Correo:</strong> <a
                                                href="mailto:capacitacion@globalcpaperu.com">capacitacion@globalcpaperu.com</a>
                                        </li>
                                        <li style="margin-bottom: 5px;"><strong>Teléfono:</strong> <a
                                                href="tel:+51967052506">+51 967 052 506</a></li>
                                        <li style="margin-bottom: 5px;"><strong>Web:</strong> <a
                                                href="https://academy.globalcpaperu.com"
                                                target="_blank">https://academy.globalcpaperu.com</a></li>
                                    </ul>
                                </div>
