        ...
        <Dialog as="div" class="relative z-50">
            ...
            <div class="fixed inset-0 overflow-y-auto">
              <div class="flex min-h-full items-center justify-center px-4 py-8">
                <DialogPanel @click.stop class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-2xl rounded-xl overflow-hidden sm:max-w-2xl sm:w-full text-black dark:text-white animate__animated animate__zoomInUp transform transition-all">
